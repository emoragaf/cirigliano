...
/**
 * This is the model class for table "visita_material".
 *
 * The followings are the available columns in table 'visita_material':
 * @property integer $id
 ...
 */
class VisitaMaterial extends MyActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, id_visita, id_material, cantidad', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return VisitaMaterial the static model class
	 */
