	...
	<div class="well">
		...
		<?php foreach ($detalle->presupuestoReparacionAdicionals as $padicional): ?>
			<tr>
				...
				<td>
					<?php echo $padicional->mano_de_obra; ?>
				</td>
				<td>
					<?php echo $padicional->cantidad*$pnormal->mano_de_obra; ?>
				</td>
			</tr>
		<?php endforeach ?>
		</table>
