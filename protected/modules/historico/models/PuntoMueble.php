...
/**
 * This is the model class for table "punto_mueble".
 *
 * The followings are the available columns in table 'punto_mueble':
 * @property integer $id
 ...
 */
class PuntoMueble extends MyActiveRecord
{
	/**
	 ...
	 * @return PuntoMueble the static model class
	 */
