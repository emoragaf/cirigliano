...
<?php $this->renderPartial('_formUpdate', array('fotos'=>$fotos,'model'=>$model,'MueblePresupuesto'=>$MueblePresupuesto,'Adicional'=>$Adicional,'TrasladoPresupuesto'=>$TrasladoPresupuesto,'campos'=>$campos,'visita'=>$visita)); ?>