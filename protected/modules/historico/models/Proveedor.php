 ...
 */
class Proveedor extends MyActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, nombre, email, telefono, celular', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'ingresoElementos' => array(self::HAS_MANY, 'IngresoElemento', 'id_proveedor'),
			'ingresoMaterials' => array(self::HAS_MANY, 'IngresoMaterial', 'id_proveedor'),
		);
	}
