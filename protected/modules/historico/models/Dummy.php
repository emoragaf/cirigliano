 ...
 */
class Dummy extends MyActiveRecord
{
	/**
	...
	public function relations()
	{
		...
		return array(
			'visitas' => array(self::MANY_MANY, 'Visita', 'checklist_dummy(id_dummy, id_visita)'),
			'puntos' => array(self::MANY_MANY, 'Punto', 'punto_dummy(id_dummy, id_punto)'),
		);
	}
