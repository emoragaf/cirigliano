...
/**
 * This is the model class for table "ingreso_elemento".
 *
 * The followings are the available columns in table 'ingreso_elemento':
 * @property integer $id
 ...
 */
class IngresoElemento extends MyActiveRecord
{
	/**
	...
	public function relations()
	{
		...
		return array(
			'detalleIngresoElementos' => array(self::HAS_MANY, 'DetalleIngresoElemento', 'id_ingreso_elemento'),
	 ...
	 * @return IngresoElemento the static model class
	 */
