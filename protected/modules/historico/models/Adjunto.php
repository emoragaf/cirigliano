 ...
 */
class Adjunto extends MyActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('id_campana', 'numerical', 'integerOnly'=>true),
			array('descripcion, tipo', 'length', 'max'=>255),
			array('nombre_archivo, archivo', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, id_campana, descripcion, nombre_archivo, tipo, archivo', 'safe', 'on'=>'search'),
		);
	}
