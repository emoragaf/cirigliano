...
class Visita extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('folio, tipo_visita, direccion_punto, region, comuna, fecha_creacion, fecha_visita, visita_preventiva, canal, distribuidor, notas, estado, descripcion_item, monto_item, punto_id, cantidad_item', 'required'),
