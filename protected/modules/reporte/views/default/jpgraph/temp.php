...
$graph->xaxis->SetTickLabels(array("a","casita","b"));

$graph->title->Set("Image maps Casas");
...
$graph->Stroke("./barras.jpg");

?>
<img src="barras.jpg?time=<?php echo date("is"); ?>" /><br />
<img src="pie.php" />
</body>
</html>