 ...
 * @property DetallePlanificacion[] $detallePlanificacions
 * @property Campana $idCampana
 */
class Planificacion extends MyActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, id_campana, descripcion, orden', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'detallePlanificacions' => array(self::HAS_MANY, 'DetallePlanificacion', 'id_planificacion'),
