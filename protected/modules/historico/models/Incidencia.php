 ...
 */
class Incidencia extends MyActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('id_tecnologia, orden', 'numerical', 'integerOnly'=>true),
			array('descripcion', 'length', 'max'=>255),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, id_tecnologia, descripcion, orden', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'fotoChecklistTecnologias' => array(self::HAS_MANY, 'FotoChecklistTecnologia', 'id_incidencia'),
