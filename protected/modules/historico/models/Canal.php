 ...
 */
class Canal extends MyActiveRecord
{
	/**
	...
	public function relations()
	{
		...
		return array(
			'precioTransporteUnos' => array(self::HAS_MANY, 'PrecioTransporteUno', 'id_canal'),
			'punto2s' => array(self::HAS_MANY, 'Punto2', 'id_canal'),
			'puntos' => array(self::HAS_MANY, 'Punto', 'id_canal'),
		);
	}
