...
/**
 * This is the model class for table "foto_reparacion".
 *
 * The followings are the available columns in table 'foto_reparacion':
 * @property integer $id
 ...
 */
class FotoReparacion extends MyActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('id_reparacion, id_tipo_foto_reparacion, orden', 'numerical', 'integerOnly'=>true),
			array('tipo', 'length', 'max'=>255),
			array('foto, observaciones, thumbnail', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, id_reparacion, id_tipo_foto_reparacion, tipo, foto, observaciones, orden, thumbnail', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return FotoReparacion the static model class
	 */
