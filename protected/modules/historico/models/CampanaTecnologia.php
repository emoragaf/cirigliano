...
/**
 * This is the model class for table "campana_tecnologia".
 *
 * The followings are the available columns in table 'campana_tecnologia':
 * @property integer $id
 ...
 */
class CampanaTecnologia extends MyActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('id_campana, id_tecnologia, cantidad', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, id_campana, id_tecnologia, cantidad', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return CampanaTecnologia the static model class
	 */
